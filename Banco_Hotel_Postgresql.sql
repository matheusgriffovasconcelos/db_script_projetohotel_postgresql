...
-- Comandos a partir do usuário tony


--Decorrente da restrição de chave estrangeira no banco relacional, foi nescessário realizar inserções de dados nas tabelas "tipo_quarto" e "quarto" do banco.
-- O insert foi feito a partir do usuário tony, pois ele tem privilégios de gerente.

INSERT INTO tipo_quarto VALUES(2, 'SUITE 3', 400.90);

INSERT INTO quarto VALUES (1, '4º', 2, default);

INSERT INTO cliente VALUES (444444, 'joao', 'M', 8645456789);

DROP TABLE tipo_quarto; -- Não tem permissão para executar este comando.


-- comando para adicionar reserva a partir do usuário Maria.

SELECT adicionaReserva(444444,1,2,'2022-07-10');

SELECT * FROM reserva --(Teste que está no artigo)



--comandos a partir do user Vitoria, estagiario.
...
-- agora alguns comandos para testar a funcionalidade do log.


INSERT INTO tipo_quarto VALUES(11, 'SUITE 7', 400.90);

INSERT INTO quarto VALUES (11, '4º', 9, default);

SELECT adicionaReserva(3333,11,2,'2022-07-10');